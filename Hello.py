...
instructions = ""
assistant_title = "J-Active DEMO by UPDEV"
...
def main():
    ...
    st.info("This assistant is designed to help you provide accurate and diplomatic responses to misinformed comments on social media regarding the Israeli-Palestinian conflict. Simply paste the comment into the chatbot, and it will offer you an informed and measured reply, based on facts, to enlighten the discussion. Our goal is to foster better understanding and constructive dialogue by bringing perspectives grounded in credible sources.")
